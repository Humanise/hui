...
public class LinkComponent<T> extends AbstractComponent {
	...
	public Object[] saveState() {
		return new Object[] { variant, core, href };
	}
	...
	protected void encodeBegin(FacesContext context, TagWriter writer) throws IOException {
		writer.startA(ClassBuilder.add("oo_link").append("oo_link_",variant));
		String id = getId();
		...
		if (href!=null) {
			...
			writer.withAttribute("href","javascript:void(0); return false;");
		}
		writer.startSpan();
	}
