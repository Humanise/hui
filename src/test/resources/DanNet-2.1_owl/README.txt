...
Prot̩g̩ 4.0beta software. For most computer configurations, however,
...
Prot̩g̩ 4.0 is developed at Stanford University and is
available from their web site (http://...). Registration is
necessary.

When Prot̩g̩ 4.0 is installed, the DanNet may loaded by selecting 
...
Setting up Prot̩g̩
------------------
Prot̩g̩ 4.0 may be set up to show 'labels' (e.g. '{jeep_1}'),
...
Navigation
----------
In Prot̩g̩ the resource is divided into several tabs in the top of 
...
(if Prot̩g̩ is set up as suggested above).
