...
doctype-system="http://www.w3.org/TR/html4/loose.dtd"/>	
	...
	<xsl:template name="p:content-head">
		...
		<script src="{$app-context}/imagegallery/js/ImageGallery.js" type="text/javascript" charset="utf-8"><xsl:comment/></script>
	</xsl:template>
	...
	<xsl:template name="p:content-editor-head">
		...
		<script src="{$app-context}/imagegallery/js/ImageGalleryEditor.js" type="text/javascript" charset="utf-8"><xsl:comment/></script>
