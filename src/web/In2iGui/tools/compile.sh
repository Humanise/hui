...
cat ${JS_LIB_PATH}In2iScripts/In2iScripts.js ${JS_LIB_PATH}prototype.js ${JS_LIB_PATH}swfobject.js ${JS_LIB_PATH}swfupload/swfupload.js ${JS_LIB_PATH}In2iScripts/In2iAnimation.js ${JS_LIB_PATH}In2iScripts/In2iInput.js ${JS_LIB_PATH}In2iScripts/In2iDate.js ${JS_LIB_PATH}json2.js ${JS_PATH}In2iGui.js ${JS_PATH}Window.js ${JS_PATH}Formula.js ${JS_PATH}List.js ${JS_PATH}Icons.js ${JS_PATH}Tabs.js ${JS_PATH}ViewStack.js ${JS_PATH}Tabbox.js ${JS_PATH}ObjectList.js ${JS_PATH}Alert.js ${JS_PATH}Button.js ${JS_PATH}Selection.js ${JS_PATH}Toolbar.js ${JS_PATH}ImagePicker.js ${JS_PATH}BoundPanel.js ${JS_PATH}RichText.js ${JS_PATH}ImageViewer.js ${JS_PATH}Picker.js ${JS_PATH}Editor.js ${JS_PATH}Menu.js ${JS_PATH}Overlay.js ${JS_PATH}Upload.js ${JS_PATH}ProgressBar.js ${JS_PATH}Gallery.js ${JS_PATH}Calendar.js ${JS_PATH}Layout.js ${JS_PATH}Dock.js ${JS_PATH}Box.js > ${JS_PATH}combined.js

echo "Concatenating basic scripts"
cat ${JS_LIB_PATH}In2iScripts/In2iScripts.js ${JS_LIB_PATH}prototype.js ${JS_LIB_PATH}In2iScripts/In2iAnimation.js ${JS_PATH}In2iGui.js > ${JS_PATH}combined.basic.js
